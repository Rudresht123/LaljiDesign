    ...
    <div class="contain-fluid px-3">
        <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
            ...
            <div class="d-none d-md-block">
                ...
                <button data-bs-toggle="modal" data-bs-target="{{ auth()->user()->hasPermission('admin.excels-import.clients-export') ? '#importdata' : ''}}"
  ...
  var tableHeadings = ['Sr. No.']; 
    headingColumns.forEach(function(column) {
        if (selectedColumns.includes(column.column_name)) {
            columnsConfig.push({ data: column.column_name, name: column.column_name });
