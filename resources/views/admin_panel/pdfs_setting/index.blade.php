        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body pd-b-0 row">
                <div class="col-lg-2 mb-3">
                    @if(auth()->user()->hasPermission('admin.global-setting.create-pdf-template'))
                              ...
                              @foreach ($pdfs as $pdf)
                                  <tr>
                                    ...
                                    <td class="d-flex justify-content-center">
                                        @if(auth()->user()->hasPermission('admin.global-setting.edit-pdf-template'))
                                        <a href="{{route('admin.global-setting.edit-pdf-template',$pdf->id)}}"  
                                            class="text-primary p-1 rounded fw-bold "><i class="far fa-edit"></i></a>
                                            @endif
                                            @if(auth()->user()->hasPermission('admin.global-setting.delete-pdf-template'))
