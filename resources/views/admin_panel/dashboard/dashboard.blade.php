...
<!-- Tarademark section end here  -->



<!-- CopyRight section start here  -->
<div class="row d-flex p-0 m-0 py-4 mt-3 custom-card" style="box-sizing:border-box;">
    <div class="col-lg-12 mb-3">
        <div class="panel  m-0 p-0  panel-default">
            <div class="panel-heading border-bottom mb-2">
                <h6 class="tx-14 m-0 p-0"><b class="d-flex"><i class="far fa-address-book me-1"></i>CopyRight
                        Clients Summary</b></h6>
            </div>
        </div>
</div>
        <!-- client Summary -->
        @include('admin_panel.dashboard.summerytemplate.CopyRight.client-summery-attorneywise')

        {{-- report section --}}

        @include('admin_panel.dashboard.summerytemplate.CopyRight.upcommingdate-data')
    </div>
    {{-- report section end here --}}
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="outer border p-3">
                                    ...
                                    <canvas id="chartPie1" class="chart_canvas"></canvas>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="outer border p-3 h-100">
                                    <div class="panel-heading border-bottom mb-2">
                                        <h6 class="tx-14 m-0 p-0">
                                            <b class="d-flex">
                                                <i class="far fa-address-book me-1"></i> Attorneys Vise Clients Summary
                                            </b>
                                        </h6>
                                    </div>
                                    <canvas id="chartBar2" class="chart_canvas p-0 m-0 my-auto"></canvas>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            let route = "{{ route('admin.chart.attoernyWiseCLientChart') }}";
