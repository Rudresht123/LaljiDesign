                            ...
                            <div class="col-lg-4 col-md-3 mb-3">
                                ...
                                <select name="main_status_id" required class="form-select select2" id="">
                                    ...
                                    @foreach ($mainStatus as $mStatus)
                                        <option value="{{ $mStatus->id ? $mStatus->id : '' }}" {{ $mStatus->id === $substatus->main_status_id ? 'selected' : '' }}>
                            ...
                            <div class="col-lg-8 col-md-9 mb-3">
                                <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <textarea class="form-control"  name="slug" id="slug" cols="2" rows="2"
                                        placeholder="Please Enter Sub Status Remark...">{{$substatus->slug ? $substatus->slug :''}}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="" class="form-label">Sub-Status-Remark</label>
