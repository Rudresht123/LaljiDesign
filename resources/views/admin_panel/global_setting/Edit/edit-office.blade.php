...
<form action="{{route('admin.global_setting.edit-office',$office->id ?? '')}}" method="POST">
                        @csrf
                        @method("PUT")
                        ...
                        <div class="gorm-group ">
                            ...
                            <input type="text" name="office_name" value="{{$office->office_name ?? ''}}" autocomplete="off" class="form-control input-sm"
                                required placeholder="Enter Office name">
                        </div>
                        <div class="gorm-group ">
                            <label for="" class="form-label">Status<span class="text-danger">*</span></label>
                            <select name="status" class="form-select" id="">
                                <option value="yes" {{$office->status == 'yes' ? 'selected' : ''}}>Active</option>
                                <option value="no" {{$office->status == 'no' ? 'selected' : ''}}>De-Active</option>
                            </select>
                        </div>
