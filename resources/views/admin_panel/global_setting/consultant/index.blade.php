        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body pd-b-0 row">
                ...
                <div class="col-lg-2 mb-3">
                    <button type="button" data-bs-toggle="modal" data-bs-target="{{  auth()->user()->hasPermission('admin.global-setting.financialYear') ? '#addModal' : '#' }}"
                ...
                <div class="{{  auth()->user()->hasPermission('admin.global-setting.financialYear') ? 'col-lg-10 mb-3' : 'col-lg-12' }} vhr">
                    <div class="table-responsive">
                        <table id="consultantTable" class="table table-hover w-100 fs-10">
