    ...
    <div id="navbarMenu" class="navbar-menu-wrapper">
        ...
        <ul class="nav navbar-menu">
            ...
            <li class="nav-item with-sub">
                <a href="javascript:void(0)" class="nav-link"><i data-feather="package"></i> Module</a>
            ...
            <li class="nav-item with-sub">
                <a href="javascript:void(0)" class="nav-link"><i data-feather="layers"></i> Global Settings</a>
