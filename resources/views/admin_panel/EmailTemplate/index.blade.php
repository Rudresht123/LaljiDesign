        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body pd-b-0 row">
                <div class="col-lg-2 mb-3">
                    @if(auth()->user()->hasPermission('admin.systemsetting.create-template'))
                    ...
                    @endif
                    @if(auth()->user()->hasPermission('admin.systemsetting.update-email-config'))
                                ...
                                @foreach ($templates as $template)
                                    <tr class="text-dark">
                                        ...
                                        <td class="d-flex justify-content-center">
                                            @if(auth()->user()->hasPermission('admin.systemsetting.edit-template'))
                                            <a href="{{route('admin.systemsetting.edit-template',$template->id)}}" class="editButton" title="Edit"><i class="far fa-edit"></i></a>
                                            @endif
                                            @if(auth()->user()->hasPermission('admin.systemsetting.delete-template'))
