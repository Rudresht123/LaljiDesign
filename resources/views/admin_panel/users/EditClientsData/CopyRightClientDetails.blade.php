        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <label for="" class="form-label">Copyright Name<span
                        class="text-danger">*</span></label>
                <input type="text"
                    value="{{ $client->copyright_name ? $client->copyright_name : '' }}"
                    class="form-control" required name="copyright_name"
                    placeholder="Copyright Name..">
            </div>

            <div class="col-sm-4">
                <label for="" class="form-label">Copyright Class<span
                        class="text-danger">*</span></label>
                <select name="trademark_class" required class="form-select" id="trademarkclass">
                    <option value="">**Please Select Copyright Class...</option>
                    @foreach ($classes as $class)
                    <option class="capitalize" value="{{ $class->class_name ? $class->class_name : '' }}"
                        {{ $class->class_name == $client->copyright_class ? 'selected' : '' }}>
            ...
            <div class="col-sm-4">
                ...
                <select name="sub_status" class="form-control select2 "
                    id="sub-status">
                </select>
            </div>
            ...
            <div class="col-sm-12">
                <label for="" class="form-label">Copyright Sub Category</label>
    ...
    <fieldset class="form-fieldset mt-4">
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <select name="deal_with" class="form-control select2 " id="deal_with">
