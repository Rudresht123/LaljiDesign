                        ...
                        <div data-label="Office Details" class="df-example">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                  ...
                                  <div class="col-lg-6">
                                    <div class="row mb-2"><div class=" pt-2 col-4 fs-10"><b>Opponenet Applicant</b></div><div class="col-8"><div class="bg-light ht-35 p-2 fs-10">{{$clientdetail->opponent_applicant ?? ''}}</div></div></div>
                                </div>
                                <div class="col-lg-6">
