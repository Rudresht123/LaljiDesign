...
Route::get('admin_panel/systemsetting/email-all-template',[EmailTemplateController::class,'index'])->middleware(['auth','verified',RolePermissionMiddleware::class])->name('admin.systemsetting.all-email-template');
...
Route::get('admin_panel/systemsetting/create-email-template',[EmailTemplateController::class,'create'])->middleware(['auth','verified',RolePermissionMiddleware::class])->name('admin.systemsetting.create-template');
...
Route::get('admin_panel/systemsetting/edit-email-template/{id}',[EmailTemplateController::class,'edit'])->middleware(['auth','verified',RolePermissionMiddleware::class])->name('admin.systemsetting.edit-template');
...
Route::get('admin_panel/systemsetting/show-email-template/{id}',[EmailTemplateController::class,'show'])->middleware(['auth','verified',RolePermissionMiddleware::class])->name('admin.systemsetting.show-template');


// email EmailConfiguration seting controller start
Route::get('admin_panel/systemsetting/email-configuration',[EmailConfiguration::class,'index'])->middleware(['auth','verified',RolePermissionMiddleware::class])->name('admin.systemsetting.update-email-config');
